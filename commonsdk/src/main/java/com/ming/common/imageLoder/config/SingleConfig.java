package com.ming.common.imageLoder.config;
...
import com.ming.common.imageLoder.utils.ImageUtil;
...
public class SingleConfig {
    ...
    public static class ConfigBuilder {
        ...
        public Animator animator; //动画资源id
         ...
         * load失败的时候显示的图片
         *
         * @param errorResId 错误状态下显示的图片资源id
         * @return
         */
        ...
        public ConfigBuilder content(String contentProvider) {
            ...
            if (contentProvider.endsWith("gif")) {
                isGif = true;
            }
        ...
        /**
         * 把资源当成bitmap来处理.如果是gif资源，则bitmap为此gif的第一帧
         ...
         * FIT_CENTER 等比例缩放图片，宽或者是高等于ImageView的宽或者是高   默认是此类型
        ...
        /**
         * 指定加载的优先级别，级别越高越优先加载，但不保证所有图片都按照顺序加载
         * @param priority 参数取值有四种
