...
public class DragGridView extends GridView {
    ...
    private Runnable mLongClickRunnable = new Runnable() {
        ...
        public void run() {
            isDrag = true;
            mVibrator.vibrate(50);  //长按之后震动表示选中。
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                mDragPosition = pointToPosition(mDownX, mDownY);   //获取到点击的是哪个position


                if (mDragPosition == AdapterView.INVALID_POSITION) {  //判断这个position是否有效
    ...
    private void createDragImage(Bitmap bitmap, int downX, int downY) {
        ...
        //mWindowLayoutParams.windowAnimations = R.anim.icon_bigger;
    ...
    onActionUpListener mOnActionUpListener = null;

    public void setOnActionUpListener(onActionUpListener e) {
        mOnActionUpListener = e;
    }
